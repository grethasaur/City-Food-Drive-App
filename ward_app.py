...
def neighbourhood_mapping():
    ...
    # Get user input for neighbourhood
    user_neighbourhood = st.text_input("Enter the neighbourhood:")
    ...
    if user_neighbourhood:
        ...
        if filtered_data.empty:
            st.write("No data found for the specified neighbourhood.")
        elif naur_data == True:
            st.write("No data found for the specified neighbourhood.")
        else:
        ...
        st.write("Please enter a neighbourhood to generate the map.")
